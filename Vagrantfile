...
Vagrant::Config.run do |config|
  ...
  config.vm.define :precise32 do |dist_config|
    dist_config.vm.box       = 'precise32'
    dist_config.vm.box_url   = 'http://files.vagrantup.com/precise32.box'
    ...
    dist_config.vm.network :bridged, :bridge => 'eth0'
